...
Este es un TPO universitario de Python.

Al iniciar, leé material/sesion-anterior.md para saber dónde quedamos.
Si necesitás entender el diseño del sistema, leé material/arquitectura-v3.md.

Trabajamos de a un módulo por vez, tal cual se detalla en el archivo de arquitectura-v3.md. Cuando termines algo, avisame y esperá
mi aprobación antes de continuar.

Si necesitás modificar algo que ya funciona, explicame por qué antes de tocarlo.
